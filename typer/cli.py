...
@app.command(name="v2")
def print_version(name: str) -> None:
    """Print featurebyte version"""
    console.print(Text(name, style="cyan") + Text(" 0.0.2", style="bold green"))


@app.command(name="v1")
def print_version(name: str) -> None:
    """Print featurebyte version"""
    console.print(Text(name, style="cyan") + Text(" 0.0.1", style="bold green"))
